import { Button, Chip, Container, Divider, Paper, Typography } from "@mui/material";
  ...
  return (
    <>
      ...
      <Container maxWidth="md">
        <Paper elevation={3}>
          <Box display="flex" flexDirection="column" alignItems="center" p={5} ref={profileRef}>
        ...
        <Box mt={2} display="flex" justifyContent="center"  sx={{ backgroundColor: 'pink', '&:hover': { backgroundColor: 'hotpink' } }}>
          <Button variant="outlined" onClick={handleDownloadPdf}>Baixe seu pokemon em PDF</Button>
        </Box>
      </Container>
    </>
  );
